...
//#define PRINT_CONTEXT_ATTENTION // in case we want to print the attention weights assigned to the context for a given source sentence
//#define PRINT_SOURCE_ATTENTION // in case we want to print the attention weights assigned to the source for a given target sentence
//---

//---
enum ATTENTION_TYPE { DOT_PRODUCT=1, ADDITIVE_MLP=2 };
enum FFL_ACTIVATION_TYPE { RELU=1, SWISH=2, SWISH_LEARNABLE_BETA=3 };
enum CONTEXT_TYPE { NEXT=1, PREV=2, NEXT_PREV=3, NEXT2=4, PREV2=5, NEXT2_PREV2=6};
//---
...
struct TransformerConfig{
	...
	bool _is_training = true;
        ...
        unsigned _context_type = CONTEXT_TYPE::NEXT;
